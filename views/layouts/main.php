		...
		<div class="container">
			...
			<div class="fr top-contact">
				<ul class="clearfix">
					...
					<li class="fl"><i class="fa fa-envelope"></i><span class="text">Email: <a
									href="mailto:your@gmail.com"><?=Yii::$app->user->identity->email;?></a></span></li>
				</ul>
			</div>
            <?php if (!Yii::$app->user->isGuest) { ?>
				<div class="fr top-contact">
					<ul class="clearfix">
						<li class="fl"><i class="fa fa-phone"></i><span
									class="text">Добро пожаловать <?=Yii::$app->user->identity->username;?></span></li>
					</ul>
				</div>
            <?php } ?>
		</div><!-- End Top Contact -->
		...
		<div class="container">
			...
			<nav class="main-navigation fr">
				<ul class="clearfix">
					...
					<li class="sub-item">
						<a href="<?=\yii\helpers\Url::to(['/site/contact'])?>" class="ln-tr">Контакты</a>
					</li>
					<li class="parent-item login">
						<a href="<?=\yii\helpers\Url::to(['/user/default/signup'])?>" class="ln-tr"><span
									class="grad-btn" <?php if (!Yii::$app->user->isGuest) { ?> style="display: none"<?php } ?>>Регистрация</span></a>
					</li>
					<li class="parent-item login">
                        <?php if (!Yii::$app->user->isGuest) { ?>
							<a href="<?=\yii\helpers\Url::to(['/user/default/logout'])?>" class="ln-tr"><span
										class="grad-btn">Выход</span></a>
                        <?php } else { ?>
							<a href="<?=\yii\helpers\Url::to(['#modalLogin'])?>" class="ln-tr" data-toggle="modal">
								<span class="grad-btn">Вход</span></a>
                        <?php } ?>
					</li>
				</ul>
				...
				<div class="col-md-3">
					<div class="widget about-widget">
						...
						<p class="about-text">
							...
							существенных финансовых и административных условий. Товарищи! постоянный количественный рост
							и сфера нашей активности позволяет оценить значение позиций, занимаемых участниками в
							...
							<ul class="slides">
								<li class="clearfix">
									...
									<div class="reale-info">
										<h4 class="footer-reale-title"><a href="#" class="ln-tr">Заголовок события</a>
										</h4>
