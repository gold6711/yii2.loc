        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <?php endif; ?>
                    <?php if(!Yii::$app->user->isGuest):?>
                            <li><a href="<?= \yii\helpers\Url::to(['/admin'])?>"><i class="fa fa-lock"></i>AdminPanel</a></li>
                    <?php endif; ?>
                            <li><a href="<?= \yii\helpers\Url::to(['/test/mytest'])?>"><i class="fa fa-exclamation-triangle"></i>TestPage</a></li>
